 ...
 */
    ...
    $mysqli = conectar();
    /**
     * Sentencia sql que consulta todo cuando la etiqueta sea igual a la que se ingresa y cuando sea formal
     */
    $st = $mysqli->prepare("SELECT * FROM publicacion WHERE (etiqueta='$etiqueta' && tipoPublicacion = 'formal')");
    $st->execute();
